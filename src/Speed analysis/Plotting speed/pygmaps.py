...
class pygmaps:
	...
	def addradpoint(self, lat,lng,rad,color = '#0000FF', fillColor = "#FF0000", fillOpacity = 0.5,\
			strokeOpacity = 1.0,\
			strokeWeight = 1):
		self.radpoints.append((lat,lng,rad,color, fillColor,fillOpacity, strokeOpacity, strokeWeight ))
	...
	def drawradpoints(self, f):
		for rpoint in self.radpoints:
			...
			self.drawPolygon(f,path,strokeColor = rpoint[3], fillColor = rpoint[4],fillOpacity = rpoint[5], strokeOpacity = rpoint[6], strokeWeight = rpoint[7])
...
if __name__ == "__main__":
	...
	# RETURN:	no returns
	#========================================================================================
	mymap.setgrids(37.42, 37.43, 1, -122.15, -122.14, 1)
